...
class WhmScheduleAdapter(
    private val list: List<Schedule>,
    private val listener: (Schedule) -> Unit
) : RecyclerView.Adapter<WhmScheduleAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.title.text = item.workDate + " " + item.timePeriod
        holder.content.text = "剩余号源：" + item.leftNumber + " / " + item.totalNumber
